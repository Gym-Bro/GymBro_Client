  ...
  return (
    <div className={css.container}>
      ...
      <div className={css.tarjetas}>
        ...
        <div className={css.tarjetas}>
          <div className={css.text}>
            ...
            <p>
              ...
              Architecto quam iste ullam id, at eveniet mollitia. Vel est
              doloribus voluptatibus debitis, libero cum quaerat doloremque
              veniam odio? Magnam, pariatur nostrum? Ea ab laudantium eaque
              laboriosam minus sint ducimus, enim deleniti saepe delectus,
              tenetur explicabo nihil veniam natus dolore sapiente, magnam sequi
              libero atque dignissimos possimus corporis architecto veritatis.
              Fugit, aliquid! Sapiente consectetur libero culpa sint hic placeat
              in delectus, blanditiis dolorem tempora sunt officia error labore
              repellat! Voluptatum aspernatur consectetur magnam consequuntur
              necessitatibus distinctio minus. Provident tenetur consequuntur
              tempore autem?
            </p>
          </div>
        ...
        <h3>Estas listo para empezar con nosotros?</h3>
        <button className="btn">Reserva una clase gratuita</button>
    </div>
